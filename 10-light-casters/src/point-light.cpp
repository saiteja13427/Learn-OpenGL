...
int main (){
    ...
    Shader objectShader("/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/pshader.vs", "/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/pshader.frag");
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        for(int i = 0; i < 10; i++){
            ...
            */
            ...
            objectShader.setFloat("light.quadratic", 0.007f);
