...
int main (){
    ...
    Shader objectShader("/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/sshader.vs", "/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/sshader.frag");
    Shader lightSourceShader("/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/lighting.vs", "/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/lighting.frag");
    ...
    unsigned char* data = stbi_load("/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/image/container2.png", &width, &height, &nRChannels, 0);
    if(data) {
    ...
    data = stbi_load("/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/image/container2_specular.png", &width, &height, &nRChannels, 0);
    if(data) {
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, data);
        glGenerateMipmap(GL_TEXTURE_2D);
    } else {
    ...
    */
    while (!glfwWindowShouldClose(window)){
        /* Inputs */
        processInput(window);
        glm::vec3 lightPos(cos(glfwGetTime()), 2.0f, sin(glfwGetTime()));
        ...
        for(int i = 0; i < 10; i++){
            ...
            */
            ...
            objectShader.setFloat("light.outerCutoff", cos(glm::radians(20.0f)));
