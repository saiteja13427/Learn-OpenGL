...
int main (){
    ...
    Shader objectShader("/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/shader.vs", "/home/saiteja/Qualcomm/preparation/opengl/10-light-casters/shaders/shader.frag");
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        for(int i = 0; i < 10; i++){
            ...
            */
            ...
            objectShader.setVec3("light.direction", 1.0f, -1.0f, -0.3f);
