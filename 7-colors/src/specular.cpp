...
int main (){
    ...
    Shader objectShader("/home/saiteja/Qualcomm/preparation/opengl/7-colors/shaders/shader.vs", "/home/saiteja/Qualcomm/preparation/opengl/7-colors/shaders/shader-specular.frag");
