...
int main (){
    ...
    Shader sh1("/home/saiteja/Qualcomm/preparation/opengl/transformations/shaders/shader.vs", "/home/saiteja/Qualcomm/preparation/opengl/transformations/shaders/shader.frag");
    ...
    unsigned char* texData = stbi_load("/home/saiteja/Qualcomm/preparation/opengl/transformations/image/container.jpg", &width, &height, &nRChannels, 0);
    ...
    unsigned char* smileData = stbi_load("/home/saiteja/Qualcomm/preparation/opengl/transformations/image/awesomeface.png", &width, &height, &nRChannels, 0);
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        */
        glm::mat4 trans = glm::mat4(1.0f);
        trans = glm::scale(trans, glm::vec3((float)glfwGetTime() / 10, 1.0f, 1.0f));
